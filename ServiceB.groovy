...
class ServiceBServlet extends HttpServlet {
    ...
    def sql = Sql.newInstance("jdbc:mysql://localhost:3306/company",username,password,"com.mysql.jdbc.Driver")
    ...
    protected void doGet(
      ...
      throws ServletException, IOException {
        ...
        def employee = sql.rows("select * from employees where department_id = ${department} and last_name LIKE ${lastname}")
